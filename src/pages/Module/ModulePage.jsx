                ...
                <Box sx={{ position: 'relative', height: "40vh", overflow: "hidden"}}>
                    ...
                    <Box sx={{position: 'absolute', top: 150, right: 10, p: 2}}>
                        <Typography variant="h5" color="white">
                            <b>{channelCount}</b> Discussions
                        </Typography>
                        <Typography variant="h5" color="white">
                            <b>{module?.students?.length + module?.teachingTeam?.length}</b> Members(s)
                        </Typography>
                        <Typography variant="h5" color="white">
                            <b>{upComingEventCount}</b> Upcoming Event(s)
                        </Typography>
                    </Box>
                </Box>
                <Box sx={{ px: 2, pb: 0 }}>
                    ...
                    {tabValue === 2 && module && (
                        <Box>
                            <ModuleEvents
                                module={module}
                                setUpComingEventCount={setUpComingEventCount}
                            />
                        </Box>
                    )}
                </Box>
